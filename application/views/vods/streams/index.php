   <div class="clear"></div>
    ...
    <div id="content-sec">
		...
		<?php foreach ($streams as $stream): ?>
                 ...
                 <?php if($stream->user->id == in_array($stream->user->id, array(228, 31))):?>
                 <!-- Stream Start -->
                        <div class="gig-post" id="mythical">
                        	...
                        	<div class="upper-sec">
                                ...
                                <div class="desc">
                                    ...
                                    <div class="txt-sec">
                                        <h3><?php echo HTML::anchor('igraci/'.$stream->user->accountid.'/stream', $stream->user->username.' <font color="#8847FF">Mythical stream</font>'); ?> </h3>
                                        ...
                                        <div class="clear"></div>
                                        <p class="txt">
                                            <font color="#8847FF">  <?=Text::limit_words(strip_tags(HTML::parse_bbcode($stream->description)), 40);?></font>
                                        </p>
