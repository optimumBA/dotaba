			...
			<li>
				<div class="thumb">
					<a href="/novosti/<?php echo $article->id.'-'.URL::title($article->title, '-', TRUE); ?>">
						<?php echo HTML::image(Media_Local_News::get($article->id), array('alt' => $article->title, 'width' => '120px')); ?>
						<span>Pogledaj</span>
					</a>
				</div>
				<div class="desc">
					<h4><a class="white" href="/novosti/<?php echo $article->id.'-'.URL::title($article->title, '-', TRUE); ?>"><?php echo $article->title; ?></a></h4>
